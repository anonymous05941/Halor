...
parser.add_argument('--scale_sys_percent', type=float, default=1.0) # Percentage of clients to scale their system configurations of the clients to make them more or less powerful
parser.add_argument('--scale_sys', type=float, default=10.0) # By how much to scale up or down the client system (e.g., if set to 2 the devices compute capabilities are doubled)
...
parser.add_argument('--modification', type=int, default=1)        

parser.add_argument('--data_regulation', type=int, default=1)      

parser.add_argument('--similarity', type=int, default=0)         

parser.add_argument('--utility_threshold_ratio', type=float, default=0.95)   
parser.add_argument('--utility_sample_ratio', type=float, default=0.7)       
parser.add_argument('--utility_sample_mode', type=float, default=3)        


parser.add_argument('--feddc', type=int, default=0)               
parser.add_argument('--feddc_alpha', type=float, default=0)         
